...
class vCard
  ...
  */
  function generateCardOutput()
    ...
    $this->output .= (string) "VERSION:3.0\r\n";
...
// FN:Name
// TITLE:Developer
// EMAIL;type=INTERNET;type=pref:johnsmith@me.com
// TEL;type=pref:650 111 1111
// ADR;type=HOME;type=pref:;;Street;City;;;Country
// URL;type=WORK;type=pref:URLLinkedin
// UID:7ba14f2a-e9c4-47b9-96ce-9ced20e2bf5a
// X-ABUID:7BA14F2A-E9C4-47B9-96CE-9CED20E2BF5A:ABPerson
// LABEL;POSTAL;ENCODING=QUOTED-PRINTABLE:=0D=0A,  =0D=0A
// LABEL;WORK;ENCODING=QUOTED-PRINTABLE:=0D=0ASan Jose, CA =0D=0AUSA
// LABEL;WORK;ENCODING=QUOTED-PRINTABLE:=0D=0A=0D=0A,  =0D=0A
// END:VCARD
